...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2025 a las 22:32:05
...
(2, 'Mario', 'juan@example.com', '961189650', 'Calle Central #13'),
(4, 'Luis ', 'xazxzax@gmail.com', '9611896450', 'dsadsadsa'),
(5, 'Carlos ', 'dsadsa@gmail.com', 'fdsfds', 'fdsvcs'),
(6, 'Mario ', 'mario@gmail.com', '9611896450', 'Calle Central #44'),
(8, 'Luis Aldana', 'luis@gmail.com', '961123452', 'Calle Central #12'),
(9, 'Osvaldo', 'osvaldo@gmail.com', '9', 'Calle Central #44'),
(10, 'Carolina ', 'carolina@gmail.com', '9611234567', 'Calle Central #25'),
(11, 'Brandon', 'brandon@gmail.com', '9611234564', 'Calle Central #12'),
(12, 'Martha', 'martha@example.com', '96112344566', 'Calle Central 12'),
(13, 'Maria', 'maria@example.com', '9611234589', 'Calle Central #13'),
(14, 'Max', 'max@gmail.com', '9611234567', 'Calle Central #44'),
(15, 'Jose', 'user1@user.com', '9611896460', 'Calle Central #1232');
...
(1, 'Luis Javier', 'luis@user.com', '1234', '2025-11-23 20:11:25'),
(5, 'Luis Manuel', 'user2@user.com', '1234QQ', '2025-11-23 21:24:54'),
(6, 'Carlos', 'carlos@ejemplo.com', 'carlos1', '2025-11-24 14:43:46');
...
ALTER TABLE `reseñas`
  ...
  ADD CONSTRAINT `reseñas_ibfk_2` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id`);
